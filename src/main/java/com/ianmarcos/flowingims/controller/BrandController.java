...
public class BrandController {
  ...
  public Brand createBrand(@RequestBody ObjectWithNameDTO newBrand) {
  ...
  @PatchMapping("/{id}")
  public Brand updateBrand(@Valid @RequestBody ObjectWithNameDTO newBrand, @PathVariable int id) {
    if (id <= 0) {
      throw new ResourceNotFoundException("The brand doesn't exist");
    }
